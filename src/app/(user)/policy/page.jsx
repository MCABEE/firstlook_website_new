...
const Policy = () => {
    const [selectedPolicy, setSelectedPolicy] = useState('Membership Policy');
                    ...
                    <section className="bg-white px-7 py-12 sm:px-16 sm:py-16 md:px-20 md:py-16 xl:px-28 xl:py-16 h-fit rounded-3xl w-[95%] xl:w-[1150px]">
                        <div className='lg:block hidden'>
                            <div className='flex md:space-x-6 lg:space-x-12 xl:space-x-16 text-[21px] font-light'>
                                <h1 onClick={() => setSelectedPolicy('Membership Policy')} className={selectedPolicy === 'Membership Policy' ? 'font-semibold border-b-2 border-[#FC3657] cursor-pointer' : 'cursor-pointer'}>
                                    Membership Policy
                                </h1>
                                <h1 onClick={() => setSelectedPolicy('Terms of use')} className={selectedPolicy === 'Terms of use' ? 'font-semibold border-b-2 border-[#FC3657] cursor-pointer' : 'cursor-pointer'}>
                                    Terms of use
                                </h1>
                                <h1 onClick={() => setSelectedPolicy('Privacy Policy')} className={selectedPolicy === 'Privacy Policy' ? 'font-semibold border-b-2 border-[#FC3657] cursor-pointer' : 'cursor-pointer'}>
                                    Privacy Policy
                                </h1>
                                <h1 onClick={() => setSelectedPolicy('Refund & Cancellation Policy')} className={selectedPolicy === 'Refund & Cancellation Policy' ? 'font-semibold border-b-2 border-[#FC3657] cursor-pointer' : 'cursor-pointer'}>
                                ...
                                list ?
                                    <div className='bg-white border border-[#444444] rounded-xl mt-4 p-4'>
                                        <div className='flex flex-col text-[16px] font-light'>
                                            <h1 onClick={() => {
                                                setSelectedPolicy('Membership Policy')
                                                setList(false)
                                            }
                                            } className={selectedPolicy === 'Membership Policy' ? 'font-semibold mt-2' : 'mt-2'}>
                                                Membership Policy
                                            </h1>
                                            <h1 onClick={() => {
                                                setSelectedPolicy('Terms of use')
                                                setList(false)
                                            }
                                            } className={selectedPolicy === 'Terms of use' ? 'font-semibold mt-2' : 'mt-2'}>
                                                Terms of use
                                            </h1>
                                            <h1 onClick={() => {
                                            ...
                                            } className={selectedPolicy === 'Privacy Policy' ? 'font-semibold mt-2' : 'mt-2'}>
                                                Privacy Policy
                                            </h1>
                                            <h1 onClick={() => {
                                                setSelectedPolicy('Refund & Cancellation Policy')
                                                setList(false)
                                            }
                                            } className={selectedPolicy === 'Refund & Cancellation Policy' ? 'font-semibold mt-2' : 'mt-2'}>
                                                Refund & Cancellation Policy
                                            </h1>
                                        </div>
                                    </div> : ''
                        ...
                        {
                            selectedPolicy === 'Membership Policy' ?
                        ...
                        {
                            selectedPolicy === 'Refund & Cancellation Policy' ?
                                <div className='text-[#444444]'>
                                    <p className={list ? 'mt-8 sm:text-[21px] font-light' : 'mt-10 sm:mt-10 lg:mt-16 sm:text-[21px] font-light'}>
                                        Effective from: 2024 April 1
                                    </p>
