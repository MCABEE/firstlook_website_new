    ...
    <div className="flex justify-center mt-0 bg-[#161616]">
      ...
      >
        <video
          ...
          muted
        />
        <div className="absolute w-[85%] mx-20 lg:mx-44 mt-32 flex items-center">
          <div className="text-left mt-48">
            ...
            >
              <Link href='/download'>
                <button className={`flex items-center font-regular text-#202020 text-xl md:px-8 md:py-3 px-6 py-2 bg-white rounded-3xl gap-4 cursor-pointer transform transition-transform duration-100 ease-in-out hover:scale-105`}>
                  Download
