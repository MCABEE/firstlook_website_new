            ...
            <div className='md:block hidden m-5'>
                <div className='px-14 flex justify-between'>
                    ...
                    <div className='flex justify-end'>
                        ...
                        <Link href='/download'>
                            <button className='flex items-center bg-[#FE1940] px-6 py-2 text-white rounded-3xl gap-4 cursor-pointer transform transition-transform duration-100 ease-in-out hover:scale-105'>
                                Download
